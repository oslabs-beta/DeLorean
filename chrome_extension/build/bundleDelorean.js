...
(function () {
    ...
    // (6:2) {#each arr as test}
    function create_each_block(ctx) {
    	let button;
    	let t_value = /*test*/ ctx[1] + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			add_location(button, file$1, 6, 2, 75);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(state, div, null);
    			current = true;
    		},
    		p: noop,
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ State, currentState, snapshot });
