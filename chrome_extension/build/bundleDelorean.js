...
(function () {
    ...
    // (43:2) {#each snapshot as instance, i}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			br = element("br");
    			attr_dev(button, "id", "button" + /*i*/ ctx[6]);
    			add_location(button, file, 44, 6, 1832);
    			add_location(span, file, 43, 4, 1819);
    			add_location(br, file, 47, 11, 1941);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(43:2) {#each snapshot as instance, i}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "main-page");
    			add_location(div, file, 41, 0, 1757);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*handleShowState, snapshot*/ 3) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function handleShowState(i) {
    		...
    		document.getElementById(`instance${i}`);
    	}
    	...
    	$$self.$capture_state = () => ({ snapshot, handleShowState, connectButton });
    	...
    	return [snapshot, handleShowState, click_handler];
    }
