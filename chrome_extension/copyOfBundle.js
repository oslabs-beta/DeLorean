...
var app = (function () {
    ...
    // (54:2) {#each things as thing}
    function create_each_block(ctx) {
    	let li;
    	let t_value = /*thing*/ ctx[9] + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			add_location(li, file, 54, 4, 2589);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*things*/ 8 && t_value !== (t_value = /*thing*/ ctx[9] + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(54:2) {#each things as thing}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = `Time travel! ${/*test*/ ctx[4]}`;
    			t8 = space();
    			div0 = element("div");
    			t9 = space();
    			...
    			add_location(h1, file, 44, 2, 2241);
    			attr_dev(button, "class", "svelte-2t9jz9");
    			add_location(button, file, 45, 2, 2329);
    			attr_dev(div0, "class", "" + (null_to_empty(/*parent*/ ctx[6]) + " svelte-2t9jz9"));
    			add_location(div0, file, 47, 2, 2437);
    			add_location(p, file, 49, 2, 2477);
    			attr_dev(div1, "class", div1_class_value = "" + (null_to_empty(/*class1*/ ctx[0]) + " svelte-2t9jz9"));
    			attr_dev(div1, "id", "target");
    			add_location(div1, file, 43, 0, 2206);
    			add_location(ul, file, 52, 0, 2554);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*timeTravel*/ ctx[5], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [class1, mph, excitement, things, test, timeTravel, parent];
    }
