...
var app = (function () {
    ...
    // (55:2) {#each things as thing}
    function create_each_block(ctx) {
    	let li;
    	let t_value = /*thing*/ ctx[10] + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			add_location(li, file, 55, 4, 2613);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*things*/ 8 && t_value !== (t_value = /*thing*/ ctx[10] + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(55:2) {#each things as thing}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = `Time travel! ${/*test*/ ctx[5]}`;
    			t8 = space();
    			div0 = element("div");
    			t9 = space();
    			...
    			attr_dev(h1, "class", "svelte-2t9jz9");
    			add_location(h1, file, 45, 2, 2262);
    			attr_dev(button, "class", "svelte-2t9jz9");
    			add_location(button, file, 46, 2, 2350);
    			attr_dev(div0, "class", "" + (null_to_empty(/*parent*/ ctx[7]) + " svelte-2t9jz9"));
    			add_location(div0, file, 48, 2, 2458);
    			add_location(p, file, 50, 2, 2498);
    			attr_dev(div1, "class", div1_class_value = "" + (null_to_empty(/*class1*/ ctx[0]) + " svelte-2t9jz9"));
    			attr_dev(div1, "id", "target");
    			add_location(div1, file, 44, 0, 2227);
    			add_location(ul, file, 53, 0, 2578);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*timeTravel*/ ctx[6], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*class1*/ 1 && div1_class_value !== (div1_class_value = "" + (null_to_empty(/*class1*/ ctx[0]) + " svelte-2t9jz9"))) {
    				attr_dev(div1, "class", div1_class_value);
    			}

    			if (dirty & /*things*/ 8) {
    				each_value = /*things*/ ctx[3];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function addChild() {
    		...
    		$$invalidate(3, things = [...things, 'another thing']);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('test1' in $$props) $$invalidate(4, test1 = $$props.test1);
    		...
    		if ('things' in $$props) $$invalidate(3, things = $$props.things);
    	};
    	...
    	return [class1, mph, excitement, things, test1, test, timeTravel, parent];
    }
