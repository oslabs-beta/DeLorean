...
(function () {
    ...
    /* client/ClientApp.svelte generated by Svelte v3.44.3 */

    const file = "client/ClientApp.svelte";
    ...
    // (43:4) {#each things as thing}
    function create_each_block(ctx) {
    	let li;
    	let t_value = /*thing*/ ctx[8] + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			attr_dev(li, "class", "svelte-1v01j7j");
    			add_location(li, file, 43, 6, 1368);
    		},
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*things*/ 4 && t_value !== (t_value = /*thing*/ ctx[8] + "")) set_data_dev(t, t_value);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(43:4) {#each things as thing}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1v01j7j");
    			add_location(h1, file, 34, 2, 1125);
    			attr_dev(button, "class", "svelte-1v01j7j");
    			add_location(button, file, 38, 2, 1224);
    			add_location(p, file, 40, 2, 1299);
    			add_location(ul, file, 41, 2, 1329);
    			attr_dev(div, "class", "container svelte-1v01j7j");
    			attr_dev(div, "id", "target");
    			add_location(div, file, 33, 0, 1087);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*timeTravel*/ ctx[3], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	validate_slots('ClientApp', slots, []);
    	let mph = 30;
    	let excitement = "";
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<ClientApp> was created with unknown prop '${key}'`);
    	});
    	...
    	return [mph, excitement, things, timeTravel];
    }

    class ClientApp extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
